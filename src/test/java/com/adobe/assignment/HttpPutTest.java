...
public class HttpPutTest extends BaseTest
{
    @Test
    public void GivenPutRequestWhenBodyExistThen200() throws IOException
    {
    ...
    @Test
    public void GivenPutRequestWhenBodyDoesNotExistThen400() throws IOException
    {
        String urlString = HOST_URL + "/";
        System.out.println(urlString);
        URL url = new URL(urlString);
